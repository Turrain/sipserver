...
#if (defined(WEBRTC_ARCH_X86_FAMILY) && !defined(__SSE2__)) || (defined(WEBRTC_ARCH_ARM_V7) && !defined(WEBRTC_ARCH_ARM_NEON))
...
#define OVERRIDE override
#elif defined(__GNUC__) && __cplusplus >= 201103 && (__GNUC__ * 10000 + __GNUC_MINOR__ * 100) >= 40700
