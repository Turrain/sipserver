...
private:
    ...
    Logger() : logToFile(false), consoleOutput(true) {
        #ifdef _WIN32
    ...
    static void outputToConsole(LogLevel level, const std::string& message) {
            ...
            WORD color;
            switch (level) {
                case LogLevel::DEBUG:   color = FOREGROUND_BLUE | FOREGROUND_GREEN | FOREGROUND_INTENSITY; break; // Bright Cyan
                case LogLevel::INFO:    color = FOREGROUND_GREEN | FOREGROUND_INTENSITY; break; // Bright Green
                case LogLevel::WARNING: color = FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_INTENSITY; break; // Bright Yellow
                case LogLevel::ERROR:   color = FOREGROUND_RED | FOREGROUND_INTENSITY; break; // Bright Red
                case LogLevel::FATAL:   color = FOREGROUND_RED | FOREGROUND_BLUE | FOREGROUND_INTENSITY; break; // Bright Magenta
                default:                color = FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_BLUE; break; // White
            }
